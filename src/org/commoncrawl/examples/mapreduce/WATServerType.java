...
public class WATServerType extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		String inputPath = "s3://aws-publicdatasets/common-crawl/crawl-data/CC-MAIN-2013-48/segments/1386163035819/wet/CC-MAIN-20131204131715-00000-ip-10-33-133-15.ec2.internal.warc.wet.gz";
